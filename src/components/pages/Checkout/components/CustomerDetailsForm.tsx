...
interface Props {
  ...
  onContactFieldChange?: (field: keyof Props["customer"]) => void;
}
...
const getPolicyPlainText = (value: string) =>
  value
    .replace(/<[^>]*>/g, " ")
    .replace(/&nbsp;/gi, " ")
    .replace(/&amp;/gi, "&")
...
const CustomerDetailsForm = ({
  ...
  const safePolicyContent = useMemo(
    () => sanitizePolicyHtml(policyContent),
    [policyContent],
  );
  const policyPreviewText = useMemo(
    () => getPolicyPlainText(policyContent),
    [policyContent],
  );

  const updateCustomerField = (
    field: keyof Props["customer"],
    value: string,
  ) => {
  ...
  return (
    <section className="space-y-[36px] -mt-[20px]">
      <h2
        className={`${SECTION_TITLE_CLASS} pt-[8px] border-b-2 border-gray-300`}
      >
        {t("customerDetails")}
      </h2>
      ...
      <div className="space-y-[36px]">
        ...
        <div className="space-y-[16px]">
          ...
          {editable ? (
            <input
              ...
              aria-describedby={
                contactErrors.name ? "guest-name-error" : undefined
              }
              className={cn(
                "mt-3 flex h-[55px] w-full items-center rounded-md border bg-white px-4 text-gray-900 outline-none transition focus:ring-2",
                contactErrors.name
        ...
        <div className="space-y-[16px]">
          ...
          {editable ? (
            <input
              ...
              aria-describedby={
                contactErrors.phone ? "guest-phone-error" : undefined
              }
              className={cn(
                "mt-3 flex h-[55px] w-full items-center rounded-md border bg-white px-4 text-gray-900 outline-none transition focus:ring-2",
                contactErrors.phone
        ...
        <div className="space-y-[16px]">
          ...
          {editable ? (
            <input
              ...
              aria-describedby={
                contactErrors.email ? "guest-email-error" : undefined
              }
              className={cn(
                "mt-3 flex h-[55px] w-full items-center rounded-md border bg-white px-4 text-gray-900 outline-none transition focus:ring-2",
                contactErrors.email
        ...
        <p className="text-sm text-gray-500 mt-2">
          {editable
            ? t("guestCustomerDetailsRequired")
