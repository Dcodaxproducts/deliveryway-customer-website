      ...
      <div className={actionsBelow ? "grid gap-3" : "grid gap-3 md:grid-cols-[1fr_auto_auto]"}>
        ...
        <div className={actionsBelow ? "grid grid-cols-[1.45fr_1fr_1fr] gap-2 sm:gap-3" : "contents"}>
          ...
          <button
            ...
            disabled={status === "missing-key" || status === "error"}
            className="inline-flex h-[49px] items-center justify-center gap-2 rounded-xl bg-primary px-3 text-xs font-semibold text-white transition hover:bg-[#d94e24] disabled:cursor-not-allowed disabled:opacity-70 sm:px-4 sm:text-sm"
          >
